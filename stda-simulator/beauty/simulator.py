...
class Simulator:
    ...
    def simulate(self):
        return scipy.integrate.solve_ivp(fun=self.solve, t_span=(0,self.t_end), y0=self.boat.get_state(), method='RK23'), self.environment_state # t_eval=np.linspace(0, self.t_end, self.stepsize))
